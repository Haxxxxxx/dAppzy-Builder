...
const TemplateFooter = forwardRef(({ handleSelect, uniqueId }, ref) => {
  ...
  const config = FooterConfigurations.advancedFooter || {};
  ...
  useEffect(() => {
    ...
    updateStyles(footerElement.id, merge({}, TemplateFooterStyles.footerSection, configStyles));
    ...
    const createElementTree = (configNode, parentId) => {
      ...
      switch (configNode.type) {
        case 'heading':
          baseStyle = TemplateFooterStyles.footerTitle || {};
          break;
        case 'paragraph':
          baseStyle = TemplateFooterStyles.footerText || {};
          break;
        case 'span':
          baseStyle = TemplateFooterStyles.footerText || {};
          break;
        case 'button':
          baseStyle = TemplateFooterStyles.footerButton || {};
          break;
        default:
          baseStyle = {};
      }
  ...
  const mergedFooterStyles = merge({}, TemplateFooterStyles.footerSection, configStyles, footerElement?.styles || {});
