...
const DeFiFooter = forwardRef(({ handleSelect, uniqueId }, ref) => {
  ...
  const config = FooterConfigurations.defiFooter || {};
  ...
  useEffect(() => {
    ...
    updateStyles(footerElement.id, merge({}, DeFiFooterStyles.footerSection, configStyles));
    ...
    const createElementTree = (configNode, parentId) => {
      ...
      switch (configNode.type) {
        case 'heading':
          baseStyle = DeFiFooterStyles.footerTitle || {};
          break;
        case 'paragraph':
          baseStyle = DeFiFooterStyles.footerText || {};
          break;
        case 'span':
          baseStyle = DeFiFooterStyles.footerText || {};
          break;
        case 'button':
          baseStyle = DeFiFooterStyles.footerButton || {};
          break;
        default:
          baseStyle = {};
      }
  ...
  const mergedFooterStyles = merge({}, DeFiFooterStyles.footerSection, configStyles, footerElement?.styles || {});
